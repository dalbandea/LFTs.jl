...
- `frc`
"""
struct Phi4workspace{T, N} <: LFTworkspace
    PRC::Type{T}
    phi::Array{T, N}
    frc::Array{T, N}
    mom::Array{T, N}
...
function copy!(phiws_dst::Phi4workspace, phiws_src::Phi4workspace, lp::Phi4Parm)
...
"""
function randomize!(phiws::Phi4workspace, lp::Phi4Parm)
